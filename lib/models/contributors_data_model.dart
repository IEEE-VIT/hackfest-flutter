...
List<Contributor> contributorFromJson(String str) => List<Contributor>.from(json.decode(str).map((x) => Contributor.fromJson(x)));

String contributorToJson(List<Contributor> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Contributor {
    ...
    factory Contributor.fromJson(Map<String, dynamic> json) => Contributor(
        ...
        contributions: json["contributions"] == null ? null : json["contributions"],
    );
