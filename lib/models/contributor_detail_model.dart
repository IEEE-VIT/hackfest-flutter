...
ContributorDetail contributorDetailFromJson(String str) => ContributorDetail.fromJson(json.decode(str));

String contributorDetailToJson(ContributorDetail data) => json.encode(data.toJson());
...
class ContributorDetail {
  ...
  factory ContributorDetail.fromJson(Map<String, dynamic> json) => ContributorDetail(
